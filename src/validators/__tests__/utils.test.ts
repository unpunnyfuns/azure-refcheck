...
describe("Validator Utils", () => {
  ...
  describe("resolveTargetPath", () => {
    ...
    test("should resolve cross-repo references", () => {
      const repoConfigs = [
        { name: "template-repo", path: "/path/to/templates", aliases: ["templates"] },
      ];
      ...
      expect(result).toBe(path.normalize("/path/to/templates/path/to/template.yml"));
    });
    ...
    test("should handle absolute paths in cross-repo references", () => {
      ...
      expect(result).toBe(path.normalize("/path/to/templates/absolute/path/template.yml"));
    });
    ...
    test("should resolve absolute paths using git repo root", () => {
      ...
      expect(result).toBe(path.normalize("/git/repo/root/absolute/path/template.yml"));
    ...
    test("should fallback to cwd if git command fails", () => {
      ...
      expect(result).toBe(path.normalize("/fallback/cwd/absolute/path/template.yml"));
